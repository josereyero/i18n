Drupal.behaviors.i18n_taxonomy = function (context) {
  if (Drupal.settings && Drupal.settings.i18n_taxonomy_vocabulary_form) {
    $('form#taxonomy-form-vocabulary input.form-radio', context).filter('[name=i18nmode]').click(function () {
      ...
      if ($(this).val() == Drupal.settings.i18n_taxonomy_vocabulary_form.I18N_TAXONOMY_LANGUAGE) {
